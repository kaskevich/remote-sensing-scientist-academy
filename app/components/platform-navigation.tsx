...
const platformNavigation = [
  ...
  { label: "Module 1", href: academyHref("/module-1/"), key: "module-1" },
  { label: "Module 2", href: academyHref("/module-2/"), key: "module-2" },
  { label: "Module 3", href: academyHref("/module-3/"), key: "module-3" },
...
export function PlatformHeader({ current }: { current?: string }) {
  return (
    <>
      ...
      <header className="site-header platform-header">
        ...
        <nav className="main-nav platform-main-nav" aria-label="Main navigation">
