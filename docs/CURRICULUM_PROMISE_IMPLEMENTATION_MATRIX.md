...
| Leakage, extrapolation and uncertainty | Academy goals | 2/3 | 2.29, 2.31–2.34, 2.48–2.49, 3.3–3.4, 3.9–3.12, 3.19–3.21 and capstone | Target, proximity, duplicate, derivative, temporal, preprocessing, selection and final-test leakage plus environmental extrapolation and applicability | Yes | Yes | Leakage checklist, nested registry, diagnostics and Domain of Applicability | COMPLETE FOR LEAKAGE AND APPLICABILITY; prediction uncertainty remains Chapter 6 |
