...
| Preprocessing and feature engineering | Academy goals | 3 | 3.3–3.4, 3.8, 3.12 | Yes for schema, transformations, missingness policy, fit/predict consistency and fold-local learned preprocessing | Yes | Yes | Feature schema, model metadata and leakage checklist | PARTIAL; feature-selection stability remains planned in 3.15 |
...
| Overfitting, hyperparameters and cross-validation | Academy goals | 2/3 | 2.48–2.49, 3.5–3.12 | Yes for bias–variance intuition, tree capacity, parameter effects, grouped/spatial/temporal CV, nested selection and leakage boundaries | Yes | Yes | Mechanism Audit, Parameter Decision Record and Structured Validation Design | COMPLETE AS FOUNDATION; controlled tuning remains planned in Chapter 4 |
