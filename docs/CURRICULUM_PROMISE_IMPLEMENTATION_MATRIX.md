...
| Regression and classification | Academy goals | 3 | 3.1, 3.5–3.8, 3.16 | Regression implemented through a first-model workflow; imbalanced rare-habitat classification now includes weighting, decision thresholds and protected assessment | Yes | Yes | First Defensible XGBoost Candidate and Rare-habitat Threshold Decision | PARTIAL; full regression, classification and probability-quality evaluation follows in Chapter 5 |
...
| Preprocessing and feature engineering | Academy goals | 3 | 3.3–3.4, 3.8, 3.12, 3.15 | Yes for schema, transformations, missingness policy, fit/predict consistency, fold-local learned preprocessing, correlated predictors and feature stability | Yes | Yes | Feature schema, model metadata, leakage checklist and Feature Stability Report | COMPLETE AS MODELLING FOUNDATION; interpretation deepens in Chapter 5 |
...
| Feature importance and interpretation | Academy goals | 3 | 3.15 | Yes for held-out permutation relevance, correlated-feature limits, fold stability and predictive-not-causal interpretation | Yes | Yes | Feature Stability Report and schema decision log | COMPLETE AS FOUNDATION; SHAP and broader interpretation follow in Chapter 5 |
...
| Leakage, extrapolation and uncertainty | Academy goals | 2/3 | 2.29, 2.31–2.34, 2.48–2.49, 3.3–3.4, 3.9–3.12 and capstone | Yes for target, proximity, duplicate, derivative, temporal, preprocessing, selection and final-test leakage | Yes | Yes | Leakage checklist, nested registry and bounded validation claim | COMPLETE FOR LEAKAGE; extrapolation and uncertainty deepen in Chapters 5–6 |
| Prediction and validation maps | Modelling card | 3 | 3.9–3.11 | Yes for split-role maps, spatial fold maps and transfer comparisons | Yes | Yes | Structured Validation Design figures and registries | COMPLETE AS FOUNDATION; residual/applicability maps remain planned |
