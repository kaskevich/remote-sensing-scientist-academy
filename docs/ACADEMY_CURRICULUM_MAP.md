...
| Modelling | 3. Remote Sensing Modelling | How can EO models be framed, trained, spatially validated, diagnosed, bounded and operationalised without leakage or causal overclaiming? | Environmental Monitoring Project | All seven chapters implemented: Lessons 3.1–3.30 establish the prediction contract, baseline, XGBoost candidate, structured validation, controlled optimisation, evaluation, residual geography, interpretation boundaries, applicability, uncertainty, scalable raster inference, a bounded Earth Engine component, architecture selection, monitoring and operational model documentation; capstone remains planned |
...
Modules 3–6 deepen predictive modelling, satellite time series, production systems and independent professional research into advanced case studies. All seven Module 3 chapters may be presented as available; its independent capstone remains planned.
...
| Sampling and spatial autocorrelation | Useful | Required | Required | Module 2 Chapter 6; Module 3 Chapters 1, 3, 4, 5, 6 and 7 preserve groups, blocks, dates and spatial folds through model selection, diagnosis, applicability, coverage and operational monitoring | Complete modelling foundation |
...
| Correct ML problem framing and metrics | Useful | Required | Required | Module 2 Chapter 11 semantic-segmentation design and baseline; Module 3 Chapters 1–7 prediction, target, baseline, metrics, probability quality, diagnostics, interval coverage and governed operation | Complete through operational modelling; independent capstone remains planned |
| Spatial CV, leakage and extrapolation control | Required for modelling pipelines | Required | Required | Module 2 Chapters 6 and 11 plus capstone; Module 3 Chapters 1, 3, 5 and 7 implement predictor/test firewalls, structured folds, residual geography, applicability and inference-time release gates | Complete modelling foundation |
